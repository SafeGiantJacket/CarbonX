...
import { idlFactory } from './issuance.did.js';
export { idlFactory } from './issuance.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ISSUANCE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./issuance.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the issuance canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./issuance.did.js")._SERVICE>}
 */
export const issuance = createActor(canisterId);
