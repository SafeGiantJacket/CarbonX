...
import { idlFactory } from './registry.did.js';
export { idlFactory } from './registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./registry.did.js")._SERVICE>}
 */
export const registry = createActor(canisterId);
