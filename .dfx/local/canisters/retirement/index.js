...
import { idlFactory } from './retirement.did.js';
export { idlFactory } from './retirement.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RETIREMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./retirement.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the retirement canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./retirement.did.js")._SERVICE>}
 */
export const retirement = createActor(canisterId);
